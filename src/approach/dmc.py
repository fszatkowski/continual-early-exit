...
class Appr(Inc_Learning_Appr):
    ...
    def __init__(self, model, device, nepochs=160, lr=0.1, lr_min=1e-4, lr_factor=10, lr_patience=8, clipgrad=10000,
        ...
        aux_trn_ldr, _, aux_val_ldr, _ = get_loaders([self.aux_dataset], num_tasks=1,
                                                     nc_first_task=None,
                                                     nc_per_task=None, validation=0,
                                                     batch_size=self.aux_batch_size, num_workers=4,
    ...
    def extra_parser(args):
        ...
        parser.add_argument('--dd-loss-correction', default=False, action='store_true',
    ...
    def train_loop(self, t, trn_loader, val_loader):
        ...
        if t > 0:
            ...
            student_trainer = StudentTrainer(self.model, self.model_new, self.model_old, self.device,
                                             dd_loss_correction=self.dd_loss_correction, **dmc_args)
